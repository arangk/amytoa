...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="//maxcdn.bootstrapcdn.com/font-awesome/5.7.0/css/font-awesome.min.css"/>
...
<div class="wrapper">
    ...
    <nav class="nav-default">
        <p class="nav-header">
            ...
            ?>
            <!--<a href="<?/*= base_url($title_url) */?>"><?/*= element('layout_title', $view) */?></a>-->
            <a href="<?= base_url($title_url) ?>">Food Outlet</a>
        </p>
        <ul class="nav">
            <?php
