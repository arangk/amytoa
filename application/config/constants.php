...
| member, PHP under CGI with Apache suEXEC, etc.).  Octal values should
...
| leaving room for others to be defined in future versions and member
| applications.
|
...
defined('EXIT_USER_INPUT')     OR define('EXIT_USER_INPUT', 7); // invalid member input
